...
A Ecologia da Paisagem estuda a relação entre a estrutura espacial do ambiente e os processos ecológicos. Ela considera a paisagem como um mosaico de manchas (patches) com diferentes usos e coberturas, e investiga como a disposição, o tamanho, a forma e a conectividade dessas manchas influenciam a biodiversidade, os fluxos de energia e matéria e a persistência das espécies. Forman e Godron (1986) definem a paisagem como um sistema heterogêneo de interações e a fragmentação florestal é um dos fenômenos centrais nesse campo.

A Bacia do Itabapoana divide território entre Espírito Santo e Rio de Janeiro, no domínio da Mata Atlântica. O bioma perdeu a maior parte da cobertura original. Ribeiro et al. (2009) estimam que restam menos de 8% do que existia. Com a fragmentação, o que importa não é só quanto resta de floresta, mas como os remanescentes se distribuem no espaço. Por isso, analisar tamanho, forma, área nuclear e isolamento dos fragmentos permite entender a qualidade do habitat e o potencial de conservação na bacia.

Analisar o tamanho (área) dos fragmentos é fundamental porque a área disponível condiciona o número de espécies e a viabilidade das populações. A maior parte dos fragmentos da Mata Atlântica tem menos de 50 ha (Ribeiro et al., 2009). Em bacias do Espírito Santo, Pirovani et al. (2014) e Santos et al. (2015) apontam na mesma direção. Fragmentos pequenos costumam abrigar menos espécies que um trecho contínuo de área equivalente: a proporção de borda em relação ao núcleo tende a ser maior (Forman & Godron, 1986).

A forma do fragmento entra na conta porque fragmentos alongados têm mais perímetro em relação à área. Patton (1975) propôs um índice que junta perímetro e área para quantificar isso. Quando o fragmento é alongado, a borda ganha peso e o núcleo diminui, o que reduz a qualidade do habitat. Forman e Godron (1986) discutem esse efeito em detalhe. A área nuclear (core area) corresponde à porção do fragmento livre da influência direta da borda. Fragmentos com área nuclear nula ou muito reduzida estão mais expostos a efeitos de borda e são considerados em maior risco. O isolamento, distância ao vizinho mais próximo, indica o quão conectado o fragmento está à rede de remanescentes. Quanto mais isolado, menor a chance de troca de indivíduos e genes. Martensen et al. (2012) associaram a conectividade à riqueza de aves de sotobosque e Mello et al. (2016) e Souza et al. (2014) usam métricas de conectividade para priorizar ações de conservação.
